...
Route::get('/api/check-auth', [AuthController::class, 'checkAuth'])->middleware('auth:sanctum');
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    //gestionar compañias
    Route::post('/parametros/guardarEmpresa', [empleadosController::class, 'guardarEmpresa']);
    Route::delete('/parametros/eliminarEmpresa/{id}', [empleadosController::class, 'eliminarEmpresa']);
...
// Ruta principal que maneja todas las rutas de la aplicación React

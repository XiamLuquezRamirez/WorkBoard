...
/**
 * Controlador para gestionar la subida y manejo de evidencias
 * 
 * Este controlador se encarga de procesar la subida de archivos de evidencias,
 * validar su integridad y almacenarlos en el sistema de archivos.
 */
class EvidenciasController extends Controller
{
    /**
     * Procesa la subida de múltiples archivos de evidencias
     * 
     * Este método maneja la subida de uno o varios archivos, los almacena en el sistema
     * y devuelve información sobre el resultado de la operación.
     * 
     * @param Request $request Solicitud HTTP que contiene los archivos a subir
     ...
     * - evidencias: array con información de los archivos subidos exitosamente
     * - errores: array con mensajes de error si los hubo
     */
